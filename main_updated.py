...
class Button:
    ...
    def draw(self, img):
        ...
        cv2.rectangle(img, self.pos, (self.pos[0] + self.width, self.pos[1] + self.height),
                      (139, 0, 0), 3)
        cv2.putText(img, self.value, (self.pos[0] + 39, self.pos[1] + 60), cv2.FONT_HERSHEY_PLAIN,
                    2, (50, 50, 50), 2)
...
while True:
    ...
    # Draw All
    cv2.rectangle(img, (750, 70), (750 + 400, 70 + 100),
        ...
        if length < 50 and delayCounter == 0:
            for i, button in enumerate(buttonList):
                if button.checkClick(x, y):
                    ...
                    cv2.putText(img, myEquation, (760, 130), cv2.FONT_HERSHEY_PLAIN,
                                3, (0, 0, 0), 3)
